...
import { update, addZone,deleteAux, deleteZone, deleteSchedule, extendReserve, getLocation, getZones, insertLocation, notifyClient, reserve, stopReserve } from './services/_index'
